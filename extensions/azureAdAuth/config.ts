exports.creds = {
  // Required
  identityMetadata:
    'https://login.microsoftonline.com/msdynomnichannel.onmicrosoft.com/v2.0/.well-known/openid-configuration',
  // or equivalently: 'https://login.microsoftonline.com/<tenant_guid>/v2.0/.well-known/openid-configuration'
  //yujincho@msdynomnichannel.onmicrosoft.com
  ...
  clientID: 'f601f4ce-ca4f-4dc1-85fb-4be4c0f22b6b',

  // Required if `responseType` is 'code', 'id_token code' or 'code id_token'.
  // If app key contains '\', replace it with '\\'.
  clientSecret: 'zO6UZoH4337THD8gY7t2qSMwAEeQ_n-.R-',
  ...
  redirectUrl: 'https://925744c21c17.ngrok.io/auth/openid/return',
